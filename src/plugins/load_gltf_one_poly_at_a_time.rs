...
use bevy::{ecs::system::SystemId, prelude::*, render::mesh::VertexAttributeValues};
use pipelines_ready::*;
...
pub struct LoadGLTF2Plugin;

impl Plugin for LoadGLTF2Plugin {
...
// Mandatory as there curently no native way to tell if an asset is loaded or not.
